...
def SamplePosterior(data = None, fitted_params = None, quiet = True, plot_num = None, min_vel = None, max_vel = None, num_gauss = None, dv = None, prev_params = None, accepted_parameters = [], con_test_limit = None, tau_tol = None, max_cores = None):
	...
	if len(new_flat_chain) != 0:
		...
		return None
def Mark(Tgas = 90, lognH2 = 4, logNOH = 14, Tdust = 0, fortho = 0.75, FWHM = 1, Av = 0, xOH = '1d-7', xHe = 0, xe = 0, Tdint = 0, Td = 0, emission = False):
	...
	with open('Temp.txt', 'r') as f:
		for line in islice(f, 33, 34):
			log_nH2, log_NOH, error, Tex_1612, tau0_1612, Tex_1665, tau0_1665, Tex_1667, tau0_1667, Tex_1720, tau0_1720, pop_1, pop_2, pop_3, pop_4, pop_5, pop_6, pop_7, pop_8, pop_9, pop_10, pop_11, pop_12, pop_13, pop_14, pop_15, pop_16, pop_17, pop_18, pop_19, pop_20, pop_21, pop_22, pop_23, pop_24, pop_25, pop_26, pop_27, pop_28, pop_29, pop_30, pop_31, pop_32 = line.split()

	# erase Temp.txt
	subprocess.run('rm Temp.txt', shell = True, stderr=subprocess.DEVNULL)

	if emission:
		return [float(log_nH2), float(log_NOH), float(Tex_1612), float(tau0_1612), float(Tex_1665), float(tau0_1665), float(Tex_1667), float(tau0_1667), float(Tex_1720), float(tau0_1720)]
	else:
		return [float(log_nH2), float(log_NOH), float(tau0_1612), float(tau0_1665), float(tau0_1667), float(tau0_1720)]
